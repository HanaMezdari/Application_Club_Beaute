...
return [
    ...
    'calendarfleur_index' => [[], ['_controller' => 'App\\Controller\\CalendarfleurController::index'], [], [['text', '/calendarfleur/']], [], []],
    'calendarfleur_new' => [[], ['_controller' => 'App\\Controller\\CalendarfleurController::new'], [], [['text', '/calendarfleur/new']], [], []],
    'calendarfleur_show' => [['id'], ['_controller' => 'App\\Controller\\CalendarfleurController::show'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/calendarfleur']], [], []],
    'calendarfleur_edit' => [['id'], ['_controller' => 'App\\Controller\\CalendarfleurController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id'], ['text', '/calendarfleur']], [], []],
    'calendarfleur_delete' => [['id'], ['_controller' => 'App\\Controller\\CalendarfleurController::delete'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/calendarfleur']], [], []],
    'calendarmahassen_index' => [[], ['_controller' => 'App\\Controller\\CalendarmahassenController::index'], [], [['text', '/calendarmahassen/']], [], []],
    'calendarmahassen_new' => [[], ['_controller' => 'App\\Controller\\CalendarmahassenController::new'], [], [['text', '/calendarmahassen/new']], [], []],
    'calendarmahassen_show' => [['id'], ['_controller' => 'App\\Controller\\CalendarmahassenController::show'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/calendarmahassen']], [], []],
    'calendarmahassen_edit' => [['id'], ['_controller' => 'App\\Controller\\CalendarmahassenController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id'], ['text', '/calendarmahassen']], [], []],
    'calendarmahassen_delete' => [['id'], ['_controller' => 'App\\Controller\\CalendarmahassenController::delete'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/calendarmahassen']], [], []],
    ...
    'mainfleur' => [[], ['_controller' => 'App\\Controller\\MainfleurController::index'], [], [['text', '/mainfleur']], [], []],
    'mainmahassen' => [[], ['_controller' => 'App\\Controller\\MainmahassenController::index'], [], [['text', '/mainmahassen']], [], []],
    ...
    'reservationfleur_index' => [[], ['_controller' => 'App\\Controller\\ReservationfleurController::index'], [], [['text', '/reservationfleur/']], [], []],
    'reservationfleur_new' => [[], ['_controller' => 'App\\Controller\\ReservationfleurController::new'], [], [['text', '/reservationfleur/new']], [], []],
    'reservationfleur_show' => [['id'], ['_controller' => 'App\\Controller\\ReservationfleurController::show'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/reservationfleur']], [], []],
    'reservationfleur_edit' => [['id'], ['_controller' => 'App\\Controller\\ReservationfleurController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id'], ['text', '/reservationfleur']], [], []],
    'reservationfleur_delete' => [['id'], ['_controller' => 'App\\Controller\\ReservationfleurController::delete'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/reservationfleur']], [], []],
    ...
    'reservationmahassen_index' => [[], ['_controller' => 'App\\Controller\\ReservationmahassenController::index'], [], [['text', '/reservationmahassen/']], [], []],
    'reservationmahassen_new' => [[], ['_controller' => 'App\\Controller\\ReservationmahassenController::new'], [], [['text', '/reservationmahassen/new']], [], []],
    'reservationmahassen_show' => [['id'], ['_controller' => 'App\\Controller\\ReservationmahassenController::show'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/reservationmahassen']], [], []],
    'reservationmahassen_edit' => [['id'], ['_controller' => 'App\\Controller\\ReservationmahassenController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id'], ['text', '/reservationmahassen']], [], []],
    'reservationmahassen_delete' => [['id'], ['_controller' => 'App\\Controller\\ReservationmahassenController::delete'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/reservationmahassen']], [], []],
    'reservationviolette_index' => [[], ['_controller' => 'App\\Controller\\ReservationvioletteController::index'], [], [['text', '/reservationviolette/']], [], []],
    'reservationviolette_new' => [[], ['_controller' => 'App\\Controller\\ReservationvioletteController::new'], [], [['text', '/reservationviolette/new']], [], []],
    'reservationviolette_show' => [['id'], ['_controller' => 'App\\Controller\\ReservationvioletteController::show'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/reservationviolette']], [], []],
    'reservationviolette_edit' => [['id'], ['_controller' => 'App\\Controller\\ReservationvioletteController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id'], ['text', '/reservationviolette']], [], []],
    'reservationviolette_delete' => [['id'], ['_controller' => 'App\\Controller\\ReservationvioletteController::delete'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/reservationviolette']], [], []],
