...
class __TwigTemplate_24b28d267302c60bd6d5aaa3cd19d26bd19a61996df58fcb34437a79880a9e94 extends Template
{
    private $source;
    private $macros = [];
...
{% for css_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_css_assets.html.twig", "/opt/lampp/htdocs/ClubBeaute/vendor/easycorp/easyadmin-bundle/src/Resources/views/includes/_css_assets.html.twig");
    }
}
